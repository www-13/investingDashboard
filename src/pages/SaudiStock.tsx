...
const SaudiStock = () => {
  const [trades, setTrades] = useLocalStorage<Trade[]>('tadawul-trades', []);
  const [customStocks, setCustomStocks] = useLocalStorage<{ symbol: string; name: string }[]>('tadawul-custom-stocks', []);
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold">Saudi Stock Exchange</h1>
              <p className="text-muted-foreground">Tadawul - Manual Price Tracking</p>
            </div>
          </div>
